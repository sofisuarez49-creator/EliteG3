import{jsxDEV as Q,Fragment as GJ}from"react/jsx-dev-runtime";const u0={apiKey:"AIzaSyAcrVq7ryWv5EJbRhZ1TmhFia-LAV10cN4",authDomain:"eliteg3-1650f.firebaseapp.com",databaseURL:"https://eliteg3-1650f-default-rtdb.firebaseio.com/",projectId:"eliteg3-1650f",storageBucket:"eliteg3-1650f.firebasestorage.app",messagingSenderId:"351711372153",appId:"1:351711372153:web:60ce4742396e37974f85a8",measurementId:"G-HGYPLEY6DJ"};if(!firebase.apps.length)firebase.initializeApp(u0);const K=firebase.database(),{useState:V,useEffect:l,useMemo:u,useRef:AJ}=React,QJ=["C","P","B","N","S","E","X","R"],f0=["R"],GQ="anonimo/galeria",KJ="__anonimo_gallery__",c0=["PERSONAJE","ETIQUETA","GENERAL"],LZ={PERSONAJE:"Personaje",ETIQUETA:"Etiqueta",GENERAL:"General"},iJ=[{id:"perfil",label:"Perfil",labels:[]},{id:"colaPiernas",label:"Cola/Piernas",labels:["C"]},{id:"pechos",label:"Pechos",labels:["P"]},{id:"cuerpoCintura",label:"Cintura/Cuerpo",labels:["N","B"]},{id:"sensualidad",label:"Sensualidad",labels:["E","S"]}],s0={perfil:"perfil",pecho:"pechos",pechos:"pechos",cola:"colaPiernas",piernas:"colaPiernas",cuerpo:"cuerpoCintura",cintura:"cuerpoCintura",sensualidad:"sensualidad"},pX=()=>iJ.reduce((_,O)=>{_[O.id]="";return _},{}),_J=(_={})=>{const O=pX(),R=_&&typeof _==="object"?_:{};return Object.keys(O).reduce((B,F)=>{B[F]=typeof R[F]==="string"?R[F].trim():"";return B},{...O})},qX=(_="")=>iJ.find((O)=>O.id===_),d0=(_="")=>s0[(_||"").trim().toLowerCase()]||"",_X={C:{bg:"linear-gradient(135deg, rgba(34,211,238,0.92), rgba(14,116,144,0.95))",border:"rgba(103,232,249,0.95)",glow:"rgba(34,211,238,0.8)",text:"#ecfeff"},P:{bg:"linear-gradient(135deg, rgba(244,114,182,0.92), rgba(157,23,77,0.95))",border:"rgba(251,207,232,0.95)",glow:"rgba(244,114,182,0.78)",text:"#fff1f2"},B:{bg:"linear-gradient(135deg, rgba(251,191,36,0.94), rgba(180,83,9,0.95))",border:"rgba(253,224,71,0.98)",glow:"rgba(251,191,36,0.82)",text:"#fffbea"},N:{bg:"linear-gradient(135deg, rgba(163,230,53,0.92), rgba(63,98,18,0.95))",border:"rgba(217,249,157,0.95)",glow:"rgba(163,230,53,0.78)",text:"#f7fee7"},S:{bg:"linear-gradient(135deg, rgba(192,132,252,0.92), rgba(107,33,168,0.95))",border:"rgba(233,213,255,0.95)",glow:"rgba(192,132,252,0.8)",text:"#faf5ff"},E:{bg:"linear-gradient(135deg, rgba(248,113,113,0.92), rgba(153,27,27,0.95))",border:"rgba(254,202,202,0.95)",glow:"rgba(248,113,113,0.8)",text:"#fef2f2"},X:{bg:"linear-gradient(135deg, rgba(239,68,68,0.98), rgba(127,29,29,0.98))",border:"rgba(254,226,226,1)",glow:"rgba(239,68,68,0.95)",text:"#fff7f7"},R:{bg:"linear-gradient(135deg, rgba(148,163,184,0.95), rgba(71,85,105,0.98))",border:"rgba(226,232,240,0.95)",glow:"rgba(148,163,184,0.82)",text:"#f8fafc"},DEFAULT:{bg:"linear-gradient(135deg, rgba(51,65,85,0.92), rgba(15,23,42,0.95))",border:"rgba(148,163,184,0.85)",glow:"rgba(148,163,184,0.45)",text:"#f8fafc"}},$Q=(_,O)=>{if(!O)return 0;return(_+O)%O},EZ=(_,O,R=!1)=>{const B=Array.isArray(O)?O.length:0;if(!B)return null;if(B===1)return 0;if(R){const F=O.map((b,d)=>({item:b,idx:d})).filter(({item:b,idx:d})=>d!==_&&b&&b.url).map(({idx:b})=>b);if(!F.length)return $Q((_??0)+1,B);return F[Math.floor(Math.random()*F.length)]}return $Q((_??0)+1,B)},lJ=(_)=>_X[_]||_X.DEFAULT,WX=(_,O=!1)=>{const R=_==="INICIAL"?_X.DEFAULT:_==="100"?_X.B:lJ(_);return{"--btn-neon-color":R.glow,borderColor:R.border,color:R.text,boxShadow:O?`inset 0 1px 0 rgba(186,230,253,0.35), 0 0 0 1px ${R.border}, 0 0 20px ${R.glow}`:`inset 0 1px 0 rgba(186,230,253,0.2), 0 0 0 1px color-mix(in srgb, ${R.border} 65%, rgba(15,23,42,0.65) 35%), 0 0 12px color-mix(in srgb, ${R.glow} 60%, transparent)`,textShadow:`0 0 8px color-mix(in srgb, ${R.glow} 70%, transparent)`,filter:O?"brightness(1.14)":"brightness(1)"}},FZ=/\.(mp4|webm|ogg|mov|m4v)(\?.*)?$/i,n0=/\.(mp3|wav|ogg|m4a|aac|flac)(\?.*)?$/i,p0=/\.gif(\?.*)?$/i,i0=/(?:youtube\.com\/(?:watch\?v=|embed\/|shorts\/)|youtu\.be\/)([A-Za-z0-9_-]{6,})/i,l0=/vimeo\.com\/(?:video\/)?(\d+)/i,HQ=(_)=>{const O=(_||"").trim();if(!O)return null;const R=O.match(i0);if(R)return{provider:"youtube",src:`https://www.youtube.com/embed/${R[1]}`,title:"Video de YouTube"};const B=O.match(l0);if(B)return{provider:"vimeo",src:`https://player.vimeo.com/video/${B[1]}`,title:"Video de Vimeo"};return null},t0=["eporner.com"],UZ=(_="")=>{const O=String(_||"").trim();if(!O||O.startsWith("data:")||O.startsWith("blob:"))return!1;try{const B=new URL(O).hostname.toLowerCase();return t0.some((F)=>B===F||B.endsWith(`.${F}`))}catch{return!1}},ZJ=(_="",O="")=>{const R=String(_||"").trim();if(!R||UZ(R))return O;return R},tJ=(_="",O="")=>{if(O==="video"||O==="image")return O;const R=(_||"").trim();if(FZ.test(R)||HQ(R))return"video";return"image"},iX=(_="")=>{return typeof _==="string"?_.trim():""},t=(_,O="")=>{if(typeof _==="string")return{url:ZJ(_.trim(),""),label:"",type:tJ(_,O),autor:""};if(_&&typeof _==="object"){const R=ZJ((_.url||"").trim(),"");return{url:R,label:QJ.includes(_.label)?_.label:"",type:tJ(R,_.type||O),autor:iX(_.autor)}}return{url:"",label:"",type:tJ("",O),autor:""}},o0=(_)=>t(_).url,VZ=(_)=>t(_).label,oJ=(_)=>t(_).type,lX=(_,O,R="image")=>Array.isArray(_?.[O])?_[O].map((B)=>t(B,R)).filter((B)=>B.url):[],a0=(_={})=>({firebaseId:KJ,nombre:"Anónimo",nacionalidad:"",ciudad:"",profesion:"Galería",fechaNacimiento:"",estaturaCm:"",fotos:[],galeria:{fotos:lX(_,"fotos","image"),gifs:lX(_,"gifs","image"),videos:lX(_,"videos","video")},batallaFotosPreferidas:pX(),puntuaciones:kQ(),isAnonymousGallery:!0}),r0=(_={})=>{if(_?.isAnonymousGallery||_?.firebaseId===KJ)return"anonimo";return _?.firebaseId||""},e0=(_={})=>{const O=ZJ(String(_?.fotos?.[0]||"").trim(),""),R=_J(_?.batallaFotosPreferidas||_?.galeria?.battlePhotoPreferences||{});if(!O)return!1;return iJ.filter((B)=>B.id!=="perfil").every((B)=>Boolean(String(R?.[B.id]||"").trim()))},J1=(_={})=>{const O=[],R=ZJ(String(_?.fotos?.[0]||"").trim(),""),B=_J(_?.batallaFotosPreferidas||_?.galeria?.battlePhotoPreferences||{});if(!R)O.push("Perfil");iJ.filter((F)=>F.id!=="perfil").forEach((F)=>{if(!String(B?.[F.id]||"").trim())O.push(F.label)});return O},Q1=(_=null)=>{if(!_)return;const O=window.open("","_blank");if(!O)return;const R=_?.firebaseId||_?.id||"",B=Array.isArray(_?.galeria?.fotos)?_.galeria.fotos.map((A)=>t(A,"image")).filter((A)=>A.url).map((A,M)=>({...A,sourceTag:"fotos",sourceIndex:M})):[],F=B.filter((A)=>A.type==="image"&&A.sourceTag==="fotos"),b=_J(_?.batallaFotosPreferidas||_?.galeria?.battlePhotoPreferences||{}),d=ZJ(String(_?.fotos?.[0]||_?.foto||"").trim(),""),XJ=B.filter((A)=>A.type==="image"&&A.url).reduce((A,M)=>{A[M.url]=M;return A},{}),n=B.length?B.map((A,M)=>`
                    <button
                        type="button"
                ...
                `).join(""):'<p class="text-slate-300">Sin imágenes en galería.</p>',D=iJ.map((A)=>{const M=A.id==="perfil",S=M?d:b[A.id]||"",N=S?M?{url:S}:XJ[S]||{url:S,label:"",sourceIndex:-1}:null,WJ=Boolean(S);return`
            ...
            <body>
                ...
                <div id="miModal" class="modal-url">
                    ...
                    <select id="nuevaFotoEtiqueta" style="width: 100%; padding: 12px; margin-top: 15px; background: #020617; border: 1px solid rgba(71,85,105,0.92); color: #e2e8f0; border-radius: 8px; outline: none; box-shadow: inset 0 1px 0 rgba(148,163,184,0.18);">
                        ${QJ.map((D)=>`<option value="${D}">Etiqueta ${D}</option>`).join("")}
                    </select>
                ...
                <details open style="width:100%; margin-bottom: 20px; border-radius: 12px; border: 1px solid rgba(148,163,184,0.28); background: rgba(2,6,23,0.45);">
                    ...
                    ${iJ.map((D)=>{const A=D.id==="perfil",M=A?n:XJ[D.id]||"",S=Boolean(M),N=!A;return`
                            <div class="gallery-slot-card" data-slot-id="${D.id}" style="border:1px solid ${S?"rgba(74,222,128,0.95)":"rgba(248,113,113,0.95)"}; border-radius:10px; padding:10px; background:${S?"linear-gradient(155deg, rgba(20,83,45,0.95) 0%, rgba(21,128,61,0.82) 45%, rgba(5,46,22,0.96) 100%)":"linear-gradient(155deg, rgba(127,29,29,0.96) 0%, rgba(185,28,28,0.84) 45%, rgba(69,10,10,0.96) 100%)"}; box-shadow: inset 0 2px 0 rgba(255,255,255,0.24), inset 0 -2px 0 rgba(2,6,23,0.45), inset 0 0 0 1px ${S?"rgba(187,247,208,0.25)":"rgba(254,202,202,0.22)"}, 0 8px 16px rgba(2,6,23,0.45), 0 0 18px ${S?"rgba(74,222,128,0.35)":"rgba(248,113,113,0.3)"}; position: relative;">
                                ...
                                <div style="margin-top:8px; border-radius:8px; overflow:hidden; aspect-ratio:4/3; border:1px dashed rgba(148,163,184,0.45); background: rgba(2,6,23,0.86); display:flex; align-items:center; justify-content:center;">
                                    ${S?`<img src="${M}" alt="Vista previa ${D.label}" onerror="${tX}" style="width:100%; height:100%; object-fit:cover; display:block;" />`:'<span style="font-size:10px; color:#fca5a5; text-transform:uppercase; letter-spacing:0.08em; font-weight:700; text-align:center; padding:0 8px;">Sin foto designada</span>'}
                                </div>
                    ...
                    ${P.length?P.map((D,A)=>{const M=o0(D),S=VZ(D),N=lJ(S),WJ={CANTANTE:{color:"#0ea5e9",sombra:"rgba(14,165,233,0.8)"},NSFW:{color:"#ef4444",sombra:"rgba(239,68,68,0.8)"},ACTRIZ:{color:"#22c55e",sombra:"rgba(34,197,94,0.8)"},MODELO:{color:"#f97316",sombra:"rgba(249,115,22,0.8)"},BAILARINA:{color:"#a855f7",sombra:"rgba(168,85,247,0.8)"},INFLUENCER:{color:"#ec4899",sombra:"rgba(236,72,153,0.8)"},PERIODISTA:{color:"#facc15",sombra:"rgba(250,204,21,0.8)"},ATLETA:{color:"#78350f",sombra:"rgba(120,53,15,0.8)"},OTRO:{color:"#ffffff",sombra:"rgba(255,255,255,0.8)"},DEFAULT:{color:"#334155",sombra:"transparent"}},f=WJ[R?.toUpperCase()]||WJ.DEFAULT;return`
                        <div
                            ...
                            style="
                                ...
                                cursor: ${oJ(D)==="image"?"grab":"pointer"};
                                position: relative;
                                background: #0f172a;
                            "
                        ...
                        >
                           <button
                            onclick="event.stopPropagation(); window.opener.postMessage({type: 'DELETE_IMAGE', index: ${D.sourceIndex}, mediaType: '${oJ(D)}', id: '${F}'}, '*');"
                            style="
                                position: absolute;
                                top: 5px;
                                right: 5px;
                            ...
                            type="button"
                        >✕</button>
                        ${oJ(D)==="video"?(()=>{const BJ=HQ(M);if(BJ)return`<div style="width: 100%; height: 100%; background: radial-gradient(circle at top, rgba(34,211,238,0.35), rgba(15,23,42,0.96)); display:flex; flex-direction:column; align-items:center; justify-content:center; gap:10px; padding: 18px; box-sizing:border-box; text-align:center;"><div style="width:64px; height:64px; border-radius:999px; border:1px solid rgba(34,211,238,0.5); background:rgba(15,23,42,0.75); display:flex; align-items:center; justify-content:center; color:#22d3ee; font-size:28px;">▶</div><div style="font-size:12px; font-weight:800; letter-spacing:0.12em; text-transform:uppercase; color:#e2e8f0;">Video embebido</div><div style="font-size:11px; color:#94a3b8; max-width:100%; word-break:break-word;">${BJ.provider.toUpperCase()}</div></div>`;return`<video src="${M}" style="width: 100%; height: 100%; object-fit: cover;" muted playsinline preload="metadata"></video>`})():`<img src="${M}" alt="Imagen de la galería" onerror="${tX}" style="width: 100%; height: 100%; object-fit: cover;" />`}
                        <div style="position:absolute; left: 12px; top: 12px; z-index: 15; padding: 6px 10px; border-radius: 999px; background: rgba(2,6,23,0.72); border: 1px solid rgba(148,163,184,0.24); color: #e2e8f0; display:flex; align-items:center; justify-content:center; font-size: 10px; font-weight: 900; letter-spacing: 0.2em; text-transform: uppercase; backdrop-filter: blur(8px);">${oJ(D)==="video"?"VIDEO":"IMG"}</div>
                ...
                <div id="fullscreenViewer" class="fullscreen-viewer">
                    ...
                    <div class="viewer-stage" id="viewerStage">
                        ${P.map((D,A)=>{const M=oJ(D),S=HQ(D.url);return`
